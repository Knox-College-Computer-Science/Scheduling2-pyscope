...
from astroplan.constraints import (AirmassConstraint, MoonSeparationConstraint, AtNightConstraint,
...
def create_blocks(targets, constraint, filters, read_out, exposures):
    blocks = []
...
def main(incomingTargets, starttime, endtime, filters=None, exposures=None, read_out=20*u.second):
...
if __name__ == '__main__':
    ...
    # Example of using custom filters and exposures
    custom_filters = ['B', 'G', 'R']
    custom_exposures = {
        'Altair': (45 * u.second, 12),
        'Vega': (45 * u.second, 12),
        'Deneb': (45 * u.second, 12),
        'M13': (90 * u.second, 12),
        'Spica': (45 * u.second, 12)
    }
